...
public class ExternalStoresApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK. API was successfully published to all the selected external stores.  </td><td>  * ETag - Entity Tag of the blocked subscription. Used by caches, or in conditional requests (This is not supported by WSO2 API Manager as of yet).  <br>  * Last-Modified - Date and time the subscription which was blocked. Used by caches, or in conditional requests (This is not supported by WSO2 API Manager as of yet).  <br>  </td></tr>
        <tr><td> 404 </td><td> Not Found. The specified resource does not exist. </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> Internal Server Error. </td><td>  -  </td></tr>
     </table>
     */
