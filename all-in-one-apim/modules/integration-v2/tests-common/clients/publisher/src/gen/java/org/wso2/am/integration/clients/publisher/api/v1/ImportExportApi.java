...
public class ImportExportApi {
     ...
     * @param preserveStatus Preserve API Status during export  (optional)
     * @param latestRevision Export the latest revision of the API  (optional, default to false)
     * @param gatewayEnvironment Gateway environment of the exported APIs  (optional)
     * @param preserveCredentials Preserve endpoint configuration credentials and secret parameters  (optional, default to false)
     ...
     */
    public okhttp3.Call exportAPICall(String apiId, String name, String version, String revisionNumber, String providerName, String format, Boolean preserveStatus, Boolean latestRevision, String gatewayEnvironment, Boolean preserveCredentials, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call exportAPIValidateBeforeCall(String apiId, String name, String version, String revisionNumber, String providerName, String format, Boolean preserveStatus, Boolean latestRevision, String gatewayEnvironment, Boolean preserveCredentials, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = exportAPICall(apiId, name, version, revisionNumber, providerName, format, preserveStatus, latestRevision, gatewayEnvironment, preserveCredentials, _callback);
        return localVarCall;
     ...
     */
    public File exportAPI(String apiId, String name, String version, String revisionNumber, String providerName, String format, Boolean preserveStatus, Boolean latestRevision, String gatewayEnvironment, Boolean preserveCredentials) throws ApiException {
        ApiResponse<File> localVarResp = exportAPIWithHttpInfo(apiId, name, version, revisionNumber, providerName, format, preserveStatus, latestRevision, gatewayEnvironment, preserveCredentials);
     ...
     */
    public ApiResponse<File> exportAPIWithHttpInfo(String apiId, String name, String version, String revisionNumber, String providerName, String format, Boolean preserveStatus, Boolean latestRevision, String gatewayEnvironment, Boolean preserveCredentials) throws ApiException {
        okhttp3.Call localVarCall = exportAPIValidateBeforeCall(apiId, name, version, revisionNumber, providerName, format, preserveStatus, latestRevision, gatewayEnvironment, preserveCredentials, null);
     ...
     */
    public okhttp3.Call exportAPIAsync(String apiId, String name, String version, String revisionNumber, String providerName, String format, Boolean preserveStatus, Boolean latestRevision, String gatewayEnvironment, Boolean preserveCredentials, final ApiCallback<File> _callback) throws ApiException {

        okhttp3.Call localVarCall = exportAPIValidateBeforeCall(apiId, name, version, revisionNumber, providerName, format, preserveStatus, latestRevision, gatewayEnvironment, preserveCredentials, _callback);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
