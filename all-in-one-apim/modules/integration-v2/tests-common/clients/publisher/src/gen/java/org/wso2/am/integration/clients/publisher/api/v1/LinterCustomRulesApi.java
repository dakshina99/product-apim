...
public class LinterCustomRulesApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> OK. Linter Custom Rules Retrieved Successfully.  </td><td>  * Content-Type - The content type of the body.  <br>  </td></tr>
     ...
     */
    public okhttp3.Call getLinterCustomRulesCall(final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/linter-custom-rules";
    ...
    private okhttp3.Call getLinterCustomRulesValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getLinterCustomRulesCall(_callback);
        return localVarCall;
    ...
    public String getLinterCustomRules() throws ApiException {
        ApiResponse<String> localVarResp = getLinterCustomRulesWithHttpInfo();
    ...
    public ApiResponse<String> getLinterCustomRulesWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getLinterCustomRulesValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get linter custom rules. (asynchronously)
     * This operation can be used to get linter custom rules from tenant-config. 
     ...
     */
    public okhttp3.Call getLinterCustomRulesAsync(final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = getLinterCustomRulesValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
